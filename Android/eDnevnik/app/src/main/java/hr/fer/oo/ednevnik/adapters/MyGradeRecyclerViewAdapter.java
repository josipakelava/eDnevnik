...
import hr.fer.oo.ednevnik.main.SubjectActivity;
...
public class MyGradeRecyclerViewAdapter extends RecyclerView.Adapter<MyGradeRecyclerViewAdapter.ViewHolder> {
    ...
    public MyGradeRecyclerViewAdapter(List<Grade> items) {
        mValues = items;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("GRADE_ID", mValues.get(position).getId().toString());
